    ...
    <div className="bg-white rounded-[40px] shadow-2xl overflow-hidden w-full max-w-6xl">
            ...
            <div className="bg-amber-50 p-6 rounded-2xl">
              ...
              <div className="space-y-4">
                <div className="flex gap-2">
                  ...
                  />
                  <button onClick={addLog} className="bg-amber-600 text-white px-4 py-3 rounded-xl hover:bg-amber-700 transition-colors">
                    <Save size={18} />
                  </button>
                </div>
      ...
      <div className="bg-gray-900 p-8 flex justify-between items-center">
        ...
        <div className="flex gap-4">
          {onClose && (
            <button onClick={onClose} className="bg-gray-700 text-white px-6 py-3 rounded-xl font-bold hover:bg-gray-600 transition-colors">
              Close
            </button>
          )}
          {onPrint && (
            <button onClick={onPrint} className="bg-blue-600 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 hover:bg-blue-700 transition-colors">
